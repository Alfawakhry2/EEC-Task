...
@section('title', __('pharmacies.add_new_pharmacy'))
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="bi bi-plus-circle"></i> {{__('pharmacies.add_new_pharmacy')}}</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('pharmacies.store') }}" method="POST">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> {{__('pharmacies.create_pharmacy')}}
                        </button>
